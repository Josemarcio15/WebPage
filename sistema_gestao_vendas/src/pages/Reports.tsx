...
function Reports() {
  ...
  const fetchSalesHistory = async () => {
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/sales/history`, {
        params: { start: startDate, end: endDate },
      });
  ...
  const handleExport = async (format: 'pdf' | 'xlsx') => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/reports/export`, {
